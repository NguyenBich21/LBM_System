...
class BookBorrowsTest < ApplicationSystemTestCase
  ...
  test "should create book borrow" do
    ...
    fill_in "Author", with: @book_borrow.author_id
    fill_in "Coupon borrow", with: @book_borrow.coupon_borrow_id
    fill_in "Publisher", with: @book_borrow.publisher_id
    fill_in "Title", with: @book_borrow.title
