...
class ClassifiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classify" do
    assert_difference("Classify.count") do
      post classifies_url, params: { classify: { classification_id: @classify.classification_id, type: @classify.type } }
    end
  ...
  test "should update classify" do
    patch classify_url(@classify), params: { classify: { classification_id: @classify.classification_id, type: @classify.type } }
