...
class LibrariansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create librarian" do
    assert_difference("Librarian.count") do
      post librarians_url, params: { librarian: { librarian_id: @librarian.librarian_id, name: @librarian.name, phone_number: @librarian.phone_number } }
    end
  ...
  test "should update librarian" do
    patch librarian_url(@librarian), params: { librarian: { librarian_id: @librarian.librarian_id, name: @librarian.name, phone_number: @librarian.phone_number } }
